...
/*
图层追踪机制（Brush Move，更新版）
- 覆盖层命中：Move 的拖拽平移需首先命中 selectionLayer/transientLayer 等覆盖层，随后读取并更新选框位置；这些队列层需开启指针事件（如 pointerEvents: "visiblePainted"）。
...
- 推荐：目标指向队列覆盖层（transientLayer/selectionLayer），保证拖拽命中与平移行为稳定。
*/
